...
std::string oauth_token = "8791292-2cjzZIJMoH0PKce5gFEgE0S6tUG9sO4Lk5fwEqPu7a"; // User-specific token acquired by auth process
std::string oauth_token_secret = "JdP26qUB0ivjgRJ3OOW1YyEQiOSNxodXXdlUNLKnzoJf7"; // User-specific secret acquired by auth process.
